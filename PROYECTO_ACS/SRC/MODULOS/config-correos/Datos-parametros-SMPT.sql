-- !DATOS TABLA ACS_PARAMETROS-- ** Seccion: Preconfiguración de parametros en la tabla ACS_PARAMETROS **
/*
...
USING (
    -- Parametro global
    SELECT 'CORREO_DBA' APA_NOMBRE_PARAMETRO, 'juancarlos19defebrerohat@gmail.com' APA_VALOR_PARAMETRO, 'Correo del DBA' APA_DESCRIPCION, 'CORREO' APA_TIPO_PARAMETRO FROM DUAL UNION ALL
    -- Configuracion SMTP
