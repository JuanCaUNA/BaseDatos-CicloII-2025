...
SELECT A.APA_ID, A.APA_FECHA, C.ACM_NOMBRE, P.APD_NOMBRE,
       A.APA_COSTO, A.APA_PAGO, A.APA_ESTADO, A.AME_ID
...
SELECT AUM_ID, ADM_ID, AEM_ID, AME_ID, APM_ID, ATU_ID,
       AUM_ESTADO_TURNO, AUM_ACCION, AUM_CAMBIOS,
       TO_CHAR(AUM_FECHA,'YYYY-MM-DD HH24:MI') AS FECHA,
       AUM_USUARIO
FROM ACS_AUDITORIA_DETALLE_MENSUAL
ORDER BY AUM_FECHA DESC FETCH FIRST 50 ROWS ONLY;
