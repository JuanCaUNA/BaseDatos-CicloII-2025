...
BEGIN
    EXECUTE IMMEDIATE 'DROP MATERIALIZED VIEW MV_ACS_SOLICITUDES_USUARIOS'; 
EXCEPTION
    WHEN OTHERS THEN
...
END;
/
CREATE MATERIALIZED VIEW MV_ACS_SOLICITUDES_USUARIOS AS
SELECT 
    APE_CEDULA, 
    APE_NOMBRE, 
    APE_P_APELLIDO, 
...
/
SELECT * FROM MV_ACS_SOLICITUDES_USUARIOS;
