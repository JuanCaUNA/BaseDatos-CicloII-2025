...
-- nombres de tablas: acs_<nombre-modulo>_<nombre> (se usa las primeras 3 del nombre del modulo, o las inciales si es un nombre compuesto)
--                    limite de largo: 30 caracteres
-- nombres de columnas:
--                      limite de largo: 30 caracteres

-- ! TABLA
create table  acs_per_permiso (
