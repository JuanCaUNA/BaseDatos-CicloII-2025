...
CREATE TABLE ACS_PERSONA (
   ...
   APR_TIPO_USUARIO   VARCHAR2(20) NOT NULL,
...
CREATE TABLE ACS_USUARIO (
   ...
   AUS_ESTADO         VARCHAR2(20) DEFAULT 'ACTIVO',
...
CREATE TABLE ACS_CUENTA_BANCARIA (
   ...
   AUS_ESTADO       VARCHAR2(8) DEFAULT 'ACTIVO',
   ...
   CONSTRAINT UK_ACU_ES_PRINCIPAL UNIQUE (AUS_ID, ACU_ES_PRINCIPAL) WHERE ACU_ES_PRINCIPAL = 1,
...
CREATE TABLE ACS_DOCUMENTO (
   ...
   ADD_ESTADO     VARCHAR2(20) DEFAULT 'PENDIENTE',
   AUS_ID        NUMBER,
   ADD_ID        NUMBER,

   ADD_FECHA_CREACION DATE DEFAULT SYSDATE,
   ADD_FECHA_ACTUALIZACION DATE DEFAULT SYSDATE,
   ...
   CONSTRAINT CHK_ADD_ESTADO CHECK (ADD_ESTADO IN ('PENDIENTE', 'APROBADO', 'RECHAZADO')),
...
CREATE OR REPLACE TRIGGER TRG_AFTER_UPDATE_PERSONA
